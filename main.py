...
spath = "images/hotel_management_software.jpg"
...
Label(sroot,text="Venkatesh Kumar",font='Timesnewroman 40 ',bg='white',fg='grey').place(x=535,y=180)
Label(sroot,text="venkatrajan446@outlook.com",font='Timesnewroman 40',bg='white',fg='grey').place(x=535,y=270)
...
def mainroot():
	...
	root.title("Made with love by Venkat")
	#--------------seperator-------------------------------------------------------------------------------------------------------------------
	...
	#-----------------------------------------------------------------
		nl = Label(b_frame,text='Made by Venkat',fg='black',bg='gray91',font='msserif 8')
	...
	def staff():
		...
		Label(emp1inf,text="Mr. Venkat Rajan",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
